...
- [关于本项目](#-关于本项目) - 3分钟了解 AgentGuide
- [6步学习路径](#-从零到offer的完整路径快速导航) - 快速导航
- [🎯 第一步：确定岗位](#-第一步确定你的目标岗位) - 算法 vs 开发
- [💡 第二步：学方法论](#-第二步拿offer的方法论) - 如何准备
- [📚 第三步：学习路线](#-第三步基于岗位的学习路线) - 详细路线图
- [💼 第四步：实战项目](#-第四步完成实战项目可写进简历) - 简历级项目
- [🎓 第五步：技术学习](#-第五步系统学习-agent-技术技术准备) - 完整知识体系
- [🎯 第六步：面试准备](#-第六步面试准备与-offer-冲刺) - 面试题库
- [🚀 快速开始](#-快速开始) - 10分钟上手
- [💬 联系作者](#-联系作者--加入社群) - 加入社群
- [📝 更多文档](#-更多文档) - FAQ、更新日志
